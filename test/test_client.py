...
from src.steampie.client import SteamClient
from src.steampie.exceptions import LoginRequired
from src.steampie.models import GameOptions, Asset
from src.steampie.utils import account_id_to_steam_id, load_credentials
...
class TestSteamClient(TestCase):
    ...
    def test_get_steam_id(self):
        ...
        self.assertEqual(
            client.get_steam_id(), int(self.steam_guard_file["Session"]["SteamID"])
        )
    ...
    def test_send_offer_without_sessionid_cookie(self):
        ...
        self.assertRaises(
            AttributeError,
            lambda: client.make_offer_with_url([my_asset], [], trade_offer_url, "TEST"),
        )
